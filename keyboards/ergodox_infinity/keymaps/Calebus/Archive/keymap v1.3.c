 ...
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |VolDwn| VolUp|Pl/Mt | Prev |Alt/Nx|                                       | Win- | Win+ |   [  |   ]  |/Func/|
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,---------------.
 *                                        |Ctl/Ap| LGui |       | RGui |Ctrl/Esc|
 *                                 ,------|------|------|       |------+--------+------.
 *                                 |Arrow/|ArrwX/| Tab  |       | Tab  | Wheel/ |Mouse/|
...
[BASE] = LAYOUT_ergodox(  // layer 0 : default
        // left hand
        KC_GESC,        KC_EXLM,      KC_AT,  KC_DLR, KC_PERC,LCTL(KC_TAB),LALT(KC_F4),
        ...
        KC_VOLD,		KC_VOLU,      KC_MPLY,KC_MPRV,ALT_T(KC_MNXT),
											    CTL_T(KC_APP),KC_LGUI,
                                                              KC_TAB,
                                               LT(ARWC,KC_SPC),LT(ARWX,KC_BSPC),KC_LALT,
        // right hand
		 KC_F6,LCTL(LSFT(KC_TAB)),		KC_NO,  KC_NO,  KC_MINS,KC_EQL, KC_BSPC,
		 RCTL(RALT(KC_NO)),KC_Y,  KC_U,   KC_I,   KC_O,   KC_P,   KC_BSLS,
					KC_H,  		  KC_J,   KC_K,	  KC_L,	  KC_SCLN,KC_QUOT,
		 MO(SYMB),  KC_N,		  KC_M,	  KC_COMM,KC_DOT, CTL_T(KC_SLSH), KC_RSPC,
					RALT(RSFT(KC_TAB)),RALT(KC_TAB),  KC_LBRC,KC_RBRC,OSL(FUNN),
 ...
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * |        |      |MsLeft|MsDown|MsRght|      |------|           |------|MsAcl0|MsAcl1| Ctrl |MsAcl2|      |        |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * |        |      |      |WhClk |      |      |      |           |      |      |      |      |      |      |        |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |      |      |   	  |      |      |                                       |      |      |      |      |      |
...
[MOUS] = LAYOUT_ergodox(
    ...
    // right hand
       KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
       KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
                KC_ACL0, KC_ACL1, KC_RCTL, KC_ACL2, KC_TRNS, KC_TRNS,
       KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
                         KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
       KC_TRNS, KC_TRNS,
       KC_TRNS,
...
[ARWC] = LAYOUT_ergodox(
       RESET,   KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
       KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
       KC_TRNS, KC_TRNS, KC_LCTRL,KC_LALT, KC_LSHIFT,KC_TRNS,
       KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
       KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
                                           KC_TRNS, KC_TRNS,
                                                    KC_TRNS,
